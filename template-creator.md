...
After verification, replace the placeholders with the script result and respond with the applicable paragraphs. For templates other than Sites, also include the card directive:
